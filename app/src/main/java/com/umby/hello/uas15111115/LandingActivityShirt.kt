...
class LandingActivityShirt : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ButtonHat.setOnClickListener {
            val intent = Intent(this, LandingActivityHat::class.java)
            startActivity(intent)
            finish()
        }
...
//        recyclerView.adapter = ProductGridAdapter(data)
    ...
    fun downloadDataFromInternet() {
        "http://demo9618857.mockable.io/list/shirt"
            .httpGet()
